...
const SigninPresenter = ({login,error}) => {
    ...
    <Container>
      <Signup>
        ...
        <LeftAdd>If you don't have an account you registered for,<br />
        try creating a new cool and sexy account! </LeftAdd>
        <Linkto to="/signup">
      ...
      <Signin>
        ...
        <Form>
            <A href="#">
                <Button style={{width:300,backgroundColor:"#E5E5E5"}}><FontAwesomeIcon icon={faGoogle} size="3x" /> </Button>
            </A>
        </Form>
      </Signin>
