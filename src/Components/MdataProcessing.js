...
const MdataProcessing = ({
  ...
  const GobtnHandler = (e) => {
    if (
      e.target.dataset.connect !== "Recruit" &&
      e.target.dataset.number == 2
    ) {
      getStudyList(true);
      setPicked({
        first: false,
        ...
        <Navbar nav={nav}>
          <div>
            <NavBtn
              ...
              data-number={1}
            >
              {connect === "Recruit" ? "Recommend" : "Manage"}
            </NavBtn>
            <NavBtn
              onClick={GobtnHandler}
              data-connect={connect}
            ...
            >
              {connect === "Recruit" ? "New" : "Joined"}
            </NavBtn>
            <NavBtn picked={picked["third"]}>
              {connect === "Recruit" ? "Imminent" : "Status"}
            </NavBtn>
          </div>
          <div
            style={{
