...
import { faHome,faCalendarAlt,faSignOutAlt,faCogs,faTable,faBell,faUser,faTimes} from '@fortawesome/free-solid-svg-icons';
    ...
    const [popup,setPopup] = useState(false);
     ...
     return (<><Back>
        <Left>
            ...
            <Title style={{ fontFamily: 'Roboto Mono, monospaced' }}>StudyRoom</Title>
            <UserContainer>
            ...
            <hr style={{backgroundColor:"var(--color-line2)",width:"140px",height:2,border:"none",margin:"10px 0",opacity:"1"}} />
            <NabvarCenter position={false}>
                    <UserInfoBtn onClick={UserInfoBtnHandler}>
                            <FontAwesomeIcon icon={faUser} size="2x" />
                    </UserInfoBtn>
                    <Link to ="/" style={{fontSize:"10px",margin:"0 10px",color:"var(--color-text2)"}}>
